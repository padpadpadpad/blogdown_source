...
- param_bds: a vector specifying the boundaries of your starting parameter estimates. It is important to __LOOK__ at your data and previous literature at this point to try and work what reasonable ranges of parameters are! 
...
library(nlsLoop) # devtools::install_github('padpadpadpad/nlsLoop')
library(dplyr)
library(magrittr)
library(tidyr)
library(ggplot2)
