...
Moving to a microbiology group has meant I now have loads of interesting genomic and sequencing data to play with!
...
seq_IDs_nest <- seq_IDs %>%
  ...
  # take just the first element of the list
  mutate(., uid = map(uid, 1))
