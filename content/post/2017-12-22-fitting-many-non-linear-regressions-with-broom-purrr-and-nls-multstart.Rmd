...
![Example Thermal Performance Curve](/img/TPC.png)
...
We can then load in the data and have a look at it using __glimpse()__. Here we shall use a dataset of thermal performance curves of metabolism of __Chlorella vulgaris__ from Padfield __et al.__ 2016.
